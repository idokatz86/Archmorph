...
export const API_PATH_TEMPLATES = Object.freeze({
  ...
  API_ADMIN_MIGRATION_QUARANTINES: "/api/admin/migration-quarantines",
  API_ADMIN_MIGRATION_QUARANTINES_ALIAS_ID_RESOLVE: "/api/admin/migration-quarantines/{alias_id}/resolve",
  ...
  API_ANALYSES_ANALYSIS_ID: "/api/analyses/{analysis_id}",
  API_ANALYSES_ANALYSIS_ID_ARTIFACTS: "/api/analyses/{analysis_id}/artifacts",
  API_ANALYSES_ANALYSIS_ID_ARTIFACTS_ARTIFACT_ID: "/api/analyses/{analysis_id}/artifacts/{artifact_id}",
  API_ANALYSES_ANALYSIS_ID_DECISIONS: "/api/analyses/{analysis_id}/decisions",
  API_ANALYSES_ANALYSIS_ID_VERSIONS: "/api/analyses/{analysis_id}/versions",
  API_ANALYSES_ANALYSIS_ID_VERSIONS_VERSION_NUMBER: "/api/analyses/{analysis_id}/versions/{version_number}",
  API_ANALYSES_ANALYSIS_ID_VERSIONS_VERSION_NUMBER_RESTORE: "/api/analyses/{analysis_id}/versions/{version_number}/restore",
  ...
  API_AUTH_SWA_SESSION: "/api/auth/swa-session",
  API_CHAT: "/api/chat",
  ...
  API_DIAGRAMS_DIAGRAM_ID_PURGE: "/api/diagrams/{diagram_id}/purge",
  ...
  API_DIAGRAMS_DIAGRAM_ID_REVIEW_QUEUE: "/api/diagrams/{diagram_id}/review-queue",
  API_DIAGRAMS_DIAGRAM_ID_REVIEW_QUEUE_SUMMARY: "/api/diagrams/{diagram_id}/review-queue/summary",
  API_DIAGRAMS_DIAGRAM_ID_REVIEW_QUEUE_ITEM_ID_DISPOSITION: "/api/diagrams/{diagram_id}/review-queue/{item_id}/disposition",
  ...
  API_DRIFT_BASELINES_BASELINE_ID_PATCH: "/api/drift/baselines/{baseline_id}/patch",
  ...
  API_JOBS: "/api/jobs",
  API_JOBS_METRICS_SUMMARY: "/api/jobs/metrics/summary",
  ...
  API_PROJECTS_DIAGRAMS: "/api/projects/diagrams",
  API_PROJECTS_PROJECT_ID: "/api/projects/{project_id}",
  API_PROJECTS_PROJECT_ID_ANALYSIS: "/api/projects/{project_id}/analysis",
  API_PROJECTS_PROJECT_ID_GENERATE: "/api/projects/{project_id}/generate",
  API_PROJECTS_PROJECT_ID_MEMBERS: "/api/projects/{project_id}/members",
  API_PROJECTS_PROJECT_ID_MEMBERS_MEMBER_USER_ID: "/api/projects/{project_id}/members/{member_user_id}",
  ...
  API_SCHEMA_COMPATIBILITY: "/api/schema-compatibility",
  ...
  API_TEMPLATES_TEMPLATE_ID: "/api/templates/{template_id}",
  API_TEMPLATES_TEMPLATE_ID_ANALYZE: "/api/templates/{template_id}/analyze",
  ...
  API_V1_ADMIN_MIGRATION_QUARANTINES: "/api/v1/admin/migration-quarantines",
  API_V1_ADMIN_MIGRATION_QUARANTINES_ALIAS_ID_RESOLVE: "/api/v1/admin/migration-quarantines/{alias_id}/resolve",
  ...
  API_V1_ANALYSES_ANALYSIS_ID: "/api/v1/analyses/{analysis_id}",
  API_V1_ANALYSES_ANALYSIS_ID_ARTIFACTS: "/api/v1/analyses/{analysis_id}/artifacts",
  API_V1_ANALYSES_ANALYSIS_ID_ARTIFACTS_ARTIFACT_ID: "/api/v1/analyses/{analysis_id}/artifacts/{artifact_id}",
  API_V1_ANALYSES_ANALYSIS_ID_DECISIONS: "/api/v1/analyses/{analysis_id}/decisions",
  API_V1_ANALYSES_ANALYSIS_ID_VERSIONS: "/api/v1/analyses/{analysis_id}/versions",
  API_V1_ANALYSES_ANALYSIS_ID_VERSIONS_VERSION_NUMBER: "/api/v1/analyses/{analysis_id}/versions/{version_number}",
  API_V1_ANALYSES_ANALYSIS_ID_VERSIONS_VERSION_NUMBER_RESTORE: "/api/v1/analyses/{analysis_id}/versions/{version_number}/restore",
  API_V1_AUTH_CONFIG: "/api/v1/auth/config",
  API_V1_AUTH_CSRF: "/api/v1/auth/csrf",
  ...
  API_V1_AUTH_SWA_SESSION: "/api/v1/auth/swa-session",
  ...
  API_V1_COLLAB_SESSIONS: "/api/v1/collab/sessions",
  API_V1_COLLAB_SESSIONS_SESSION_ID: "/api/v1/collab/sessions/{session_id}",
  API_V1_COLLAB_SESSIONS_SESSION_ID_CHANGES: "/api/v1/collab/sessions/{session_id}/changes",
  API_V1_COLLAB_SESSIONS_SESSION_ID_JOIN: "/api/v1/collab/sessions/{session_id}/join",
  ...
  API_V1_DIAGRAMS_DIAGRAM_ID_DIFF: "/api/v1/diagrams/{diagram_id}/diff",
  ...
  API_V1_DIAGRAMS_DIAGRAM_ID_MIGRATION_TIMELINE: "/api/v1/diagrams/{diagram_id}/migration-timeline",
  API_V1_DIAGRAMS_DIAGRAM_ID_MIGRATION_TIMELINE_EXPORT: "/api/v1/diagrams/{diagram_id}/migration-timeline/export",
  API_V1_DIAGRAMS_DIAGRAM_ID_NETWORK_TOPOLOGY: "/api/v1/diagrams/{diagram_id}/network-topology",
  ...
  API_V1_DIAGRAMS_DIAGRAM_ID_PURGE: "/api/v1/diagrams/{diagram_id}/purge",
  ...
  API_V1_DIAGRAMS_DIAGRAM_ID_REVIEW_QUEUE: "/api/v1/diagrams/{diagram_id}/review-queue",
  API_V1_DIAGRAMS_DIAGRAM_ID_REVIEW_QUEUE_SUMMARY: "/api/v1/diagrams/{diagram_id}/review-queue/summary",
  API_V1_DIAGRAMS_DIAGRAM_ID_REVIEW_QUEUE_ITEM_ID_DISPOSITION: "/api/v1/diagrams/{diagram_id}/review-queue/{item_id}/disposition",
  API_V1_DIAGRAMS_DIAGRAM_ID_SHARE: "/api/v1/diagrams/{diagram_id}/share",
  ...
  API_V1_DIAGRAMS_DIAGRAM_ID_VERSIONS_SAVE: "/api/v1/diagrams/{diagram_id}/versions/save",
  ...
  API_V1_DIAGRAMS_DIAGRAM_ID_VERSIONS_VERSION_BRANCH: "/api/v1/diagrams/{diagram_id}/versions/{version}/branch",
  ...
  API_V1_DRIFT_BASELINES_BASELINE_ID_PATCH: "/api/v1/drift/baselines/{baseline_id}/patch",
  ...
  API_V1_ICON_PACKS: "/api/v1/icon-packs",
  API_V1_ICON_PACKS_PACK_ID: "/api/v1/icon-packs/{pack_id}",
  API_V1_ICONS: "/api/v1/icons",
  API_V1_ICONS_METRICS: "/api/v1/icons/metrics",
  API_V1_ICONS_PACKS: "/api/v1/icons/packs",
  API_V1_ICONS_ICON_ID_SVG: "/api/v1/icons/{icon_id}/svg",
  ...
  API_V1_INTEGRATIONS_GITHUB_PUSH_PR: "/api/v1/integrations/github/push-pr",
  ...
  API_V1_JOBS_METRICS_SUMMARY: "/api/v1/jobs/metrics/summary",
  ...
  API_V1_LIBRARIES_DRAWIO: "/api/v1/libraries/drawio",
  API_V1_LIBRARIES_EXCALIDRAW: "/api/v1/libraries/excalidraw",
  API_V1_LIBRARIES_VISIO: "/api/v1/libraries/visio",
  API_V1_MODELS: "/api/v1/models/",
  API_V1_MODELS_MODEL_ID: "/api/v1/models/{model_id}",
  API_V1_NETWORK_CIDR_CALCULATOR: "/api/v1/network/cidr-calculator",
  ...
  API_V1_PROJECTS_DIAGRAMS: "/api/v1/projects/diagrams",
  API_V1_PROJECTS_PROJECT_ID: "/api/v1/projects/{project_id}",
  API_V1_PROJECTS_PROJECT_ID_ANALYSIS: "/api/v1/projects/{project_id}/analysis",
  API_V1_PROJECTS_PROJECT_ID_GENERATE: "/api/v1/projects/{project_id}/generate",
  API_V1_PROJECTS_PROJECT_ID_MEMBERS: "/api/v1/projects/{project_id}/members",
  API_V1_PROJECTS_PROJECT_ID_MEMBERS_MEMBER_USER_ID: "/api/v1/projects/{project_id}/members/{member_user_id}",
  API_V1_REPLAY_EVENTS: "/api/v1/replay/events",
  API_V1_REPLAY_RECORD: "/api/v1/replay/record",
  API_V1_REPLAY_REPLAY_ID: "/api/v1/replay/{replay_id}",
  API_V1_REPLAY_REPLAY_ID_EXPORT: "/api/v1/replay/{replay_id}/export",
  API_V1_REPLAYS: "/api/v1/replays",
  ...
  API_V1_SCHEMA_COMPATIBILITY: "/api/v1/schema-compatibility",
  ...
  API_V1_SHARED_SHARE_ID: "/api/v1/shared/{share_id}",
  API_V1_SHARED_SHARE_ID_STATS: "/api/v1/shared/{share_id}/stats",
  ...
  API_V1_TEMPLATES: "/api/v1/templates",
  API_V1_TEMPLATES_TEMPLATE_ID: "/api/v1/templates/{template_id}",
  API_V1_TEMPLATES_TEMPLATE_ID_ANALYZE: "/api/v1/templates/{template_id}/analyze",
  ...
  API_V1_WORKSPACES: "/api/v1/workspaces",
  API_V1_WORKSPACES_WORKSPACE_ID: "/api/v1/workspaces/{workspace_id}",
  API_V1_WORKSPACES_WORKSPACE_ID_ANALYSES: "/api/v1/workspaces/{workspace_id}/analyses",
