    ...
    <div className="space-y-6">
      ...
      {filtered.length === 0 ? (
        <EmptyState
          ...
          description="We couldn't find any services matching your current filters. Try relaxing your search terms."
          actionLabel="Clear Filters"
          onAction={() => { setSearch(''); setProvider('all'); setCategory('all'); }}
        />
      ) : (
