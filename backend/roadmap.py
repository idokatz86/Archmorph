...
RELEASE_TIMELINE: List[Dict[str, Any]] = [
    ...
    # ═══════════════════════════════════════════════════════════
    {
        ...
        "highlights": [
            "Gunicorn process manager with worker recycling",
            "Async CPU-bound handlers (best_practices, cost_optimizer)",
            "Parallel image classify + analyze",
            "Split diagrams.py god router into focused modules",
            "Code quality: docstrings, complexity reduction, dead code removal",
            "Toast notification system, skeleton loaders, beforeunload guard",
            "Accessibility improvements (ARIA, focus management, screen reader)",
    ...
    },
    {
        ...
        "highlights": [
            ...
            "Cost estimate drill-down with per-service configurability",
            "Full analysis PDF report export",
    ...
    },
    {
        ...
        "highlights": [
            ...
            "Collaboration — shared projects, comments, review workflow",
            "Compliance framework mapping & gap analysis",
        ],
    },
    {
        "version": "4.0.0",
        ...
        "highlights": [
            ...
            "Pulumi & CDK IaC output",
            "VS Code extension",
            "Real infrastructure scanning via cloud SDKs",
            "End-to-end migration wizard",
            "Interactive before/after architecture visualization",
        ],
    },
    # ═══════════════════════════════════════════════════════════
