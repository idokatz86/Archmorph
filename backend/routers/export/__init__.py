"""
Export domain — routes for reports, sharing, timeline, gallery, collaboration, replay.

Consolidates 7 router files into one importable package (#503).
"""
...
from routers.gallery_routes import router as gallery_router
...
domain_router.include_router(gallery_router)
