"""
AI domain — routes for chat, RAG, suggestions, provenance.

Consolidates 4 router files into one importable package (#503).
"""
...
domain_router.include_router(rag_router)
